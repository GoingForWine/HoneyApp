        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                await _emailSender.SendEmailAsync(
                    ...
                    $"Моля потвърдете си имейлът като <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>цъкнете тук</a>.");

                StatusMessage = "Линк ви беше изпратен на имейал за проверка. Моля, проверете си имейла.";
