...
namespace HoneyWebPlatform.Data.Migrations
{
    ...
    [Migration("20240106124424_AddingOrderModelandOrderItemModel")]
    partial class AddingOrderModelandOrderItemModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HoneyWebPlatform.Data.Models.BeePollen", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1a92dc6b-d7a2-4853-8c40-5f5cb97aebd3"),
                            BeekeeperId = new Guid("7adaf90e-fec8-492e-8760-fe3190f1d689"),
                            CreatedOn = new DateTime(2024, 1, 6, 12, 44, 22, 918, DateTimeKind.Utc).AddTicks(104),
            ...
            modelBuilder.Entity("HoneyWebPlatform.Data.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("13de4ee4-968c-41d9-816e-73b58e50707f"),
                            AuthorId = new Guid("bd56fe08-bd10-4384-89be-63a211fbbc61"),
                            Content = "This is the first comment on the first post!",
                            CreatedOn = new DateTime(2024, 1, 6, 14, 44, 22, 918, DateTimeKind.Local).AddTicks(5146),
                            IsActive = true,
            ...
            modelBuilder.Entity("HoneyWebPlatform.Data.Models.Honey", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0b4dba9f-0192-4ec8-bb8c-29d8050cf3de"),
                            BeekeeperId = new Guid("7adaf90e-fec8-492e-8760-fe3190f1d689"),
                            CategoryId = 1,
            ...
            modelBuilder.Entity("HoneyWebPlatform.Data.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("04445f5f-3764-46a7-8d6b-0b741772a08e"),
                            AuthorId = new Guid("bd56fe08-bd10-4384-89be-63a211fbbc61"),
            ...
            modelBuilder.Entity("HoneyWebPlatform.Data.Models.Propolis", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c46673ff-8197-4cb2-bd56-ed9143bf8eff"),
                            BeekeeperId = new Guid("7adaf90e-fec8-492e-8760-fe3190f1d689"),
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("HoneyWebPlatform.Data.Models.OrderItem", b =>
                {
                    b.HasOne("HoneyWebPlatform.Data.Models.Order", null)
                        .WithMany("OrderItems")
