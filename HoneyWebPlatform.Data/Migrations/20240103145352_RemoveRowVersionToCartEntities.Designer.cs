...
namespace HoneyWebPlatform.Data.Migrations
{
    ...
    [Migration("20240103145352_RemoveRowVersionToCartEntities")]
    partial class RemoveRowVersionToCartEntities
    {
            ...
            modelBuilder.Entity("HoneyWebPlatform.Data.Models.BeePollen", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2d4e0da9-2484-4853-b71c-89d25a633f2c"),
                            BeekeeperId = new Guid("7adaf90e-fec8-492e-8760-fe3190f1d689"),
                            CreatedOn = new DateTime(2024, 1, 3, 14, 53, 51, 604, DateTimeKind.Utc).AddTicks(1437),
            ...
            modelBuilder.Entity("HoneyWebPlatform.Data.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bec010dd-91aa-4435-8d51-e8c4283c5abc"),
                            AuthorId = new Guid("bd56fe08-bd10-4384-89be-63a211fbbc61"),
                            Content = "This is the first comment on the first post!",
                            CreatedOn = new DateTime(2024, 1, 3, 16, 53, 51, 604, DateTimeKind.Local).AddTicks(6237),
                            IsActive = true,
            ...
            modelBuilder.Entity("HoneyWebPlatform.Data.Models.Honey", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("eea522cb-f781-4b1a-90a6-782510ffbc5e"),
                            BeekeeperId = new Guid("7adaf90e-fec8-492e-8760-fe3190f1d689"),
                            CategoryId = 1,
            ...
            modelBuilder.Entity("HoneyWebPlatform.Data.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("16d80fe5-9cbc-42ad-b87a-244c5faf02db"),
                            AuthorId = new Guid("bd56fe08-bd10-4384-89be-63a211fbbc61"),
            ...
            modelBuilder.Entity("HoneyWebPlatform.Data.Models.Propolis", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3b51286f-3bd8-4bfe-b76f-0f647d49fe4e"),
                            BeekeeperId = new Guid("7adaf90e-fec8-492e-8760-fe3190f1d689"),
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
