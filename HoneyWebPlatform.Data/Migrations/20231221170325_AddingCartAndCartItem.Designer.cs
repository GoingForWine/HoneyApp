...
namespace HoneyWebPlatform.Data.Migrations
{
    ...
    [Migration("20231221170325_AddingCartAndCartItem")]
            ...
            modelBuilder.Entity("HoneyWebPlatform.Data.Models.BeePollen", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("13126152-e450-44c2-9001-6d91d9831809"),
                            BeekeeperId = new Guid("7adaf90e-fec8-492e-8760-fe3190f1d689"),
                            CreatedOn = new DateTime(2023, 12, 21, 17, 3, 24, 794, DateTimeKind.Utc).AddTicks(6881),
            ...
            modelBuilder.Entity("HoneyWebPlatform.Data.Models.CartItem", b =>
                {
                    ...
                    b.Property<Guid>("HoneyId1")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("PropolisId")
                        .HasColumnType("int");

                    b.Property<Guid>("PropolisId1")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HoneyWebPlatform.Data.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2fbb26ff-2a82-4600-af60-1753e06a42ae"),
                            AuthorId = new Guid("bd56fe08-bd10-4384-89be-63a211fbbc61"),
                            Content = "This is the first comment on the first post!",
                            CreatedOn = new DateTime(2023, 12, 21, 19, 3, 24, 795, DateTimeKind.Local).AddTicks(3174),
                            IsActive = true,
            ...
            modelBuilder.Entity("HoneyWebPlatform.Data.Models.Honey", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b46df457-80d1-4cb1-bdea-e73f9a052690"),
                            BeekeeperId = new Guid("7adaf90e-fec8-492e-8760-fe3190f1d689"),
                            CategoryId = 1,
            ...
            modelBuilder.Entity("HoneyWebPlatform.Data.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5ff344a2-1bd0-4623-a51d-8ad3a3227d51"),
                            AuthorId = new Guid("bd56fe08-bd10-4384-89be-63a211fbbc61"),
            ...
            modelBuilder.Entity("HoneyWebPlatform.Data.Models.Propolis", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("59a51cdf-f946-48fe-b912-a0091d48b51a"),
                            BeekeeperId = new Guid("7adaf90e-fec8-492e-8760-fe3190f1d689"),
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
