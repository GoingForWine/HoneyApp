...
namespace HoneyWebPlatform.Data.Migrations
{
    ...
    [Migration("20231222123846_UpdatingCartAndCartItem")]
    partial class UpdatingCartAndCartItem
    {
            ...
            modelBuilder.Entity("HoneyWebPlatform.Data.Models.BeePollen", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6471fdf0-ab8d-4e42-b550-6a856e17fc2f"),
                            BeekeeperId = new Guid("7adaf90e-fec8-492e-8760-fe3190f1d689"),
                            CreatedOn = new DateTime(2023, 12, 22, 12, 38, 45, 517, DateTimeKind.Utc).AddTicks(9933),
            ...
            modelBuilder.Entity("HoneyWebPlatform.Data.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cd87ee6c-834f-4213-b861-2c34cb5de548"),
                            AuthorId = new Guid("bd56fe08-bd10-4384-89be-63a211fbbc61"),
                            Content = "This is the first comment on the first post!",
                            CreatedOn = new DateTime(2023, 12, 22, 14, 38, 45, 518, DateTimeKind.Local).AddTicks(4853),
                            IsActive = true,
            ...
            modelBuilder.Entity("HoneyWebPlatform.Data.Models.Honey", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9d37df19-dfd7-4cc5-8cef-090bb6495233"),
                            BeekeeperId = new Guid("7adaf90e-fec8-492e-8760-fe3190f1d689"),
                            CategoryId = 1,
            ...
            modelBuilder.Entity("HoneyWebPlatform.Data.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5e9f9ad3-daa4-4239-9904-0e852477ce38"),
                            AuthorId = new Guid("bd56fe08-bd10-4384-89be-63a211fbbc61"),
            ...
            modelBuilder.Entity("HoneyWebPlatform.Data.Models.Propolis", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6206ab70-0e37-4789-922f-c8a403430b70"),
                            BeekeeperId = new Guid("7adaf90e-fec8-492e-8760-fe3190f1d689"),
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
